...
public class UserDao extends AbstractDao<User, Long> {
    ...
    private Query<User> book_UsersQuery;
    ...
    /** Internal query to resolve the "users" to-many relationship of Book. */
    public List<User> _queryBook_Users(Long bookId) {
        synchronized (this) {
            if (book_UsersQuery == null) {
                QueryBuilder<User> queryBuilder = queryBuilder();
                queryBuilder.join(Collect.class, CollectDao.Properties.UserId)
                    .where(CollectDao.Properties.BookId.eq(bookId));
                book_UsersQuery = queryBuilder.build();
            }
        }
        Query<User> query = book_UsersQuery.forCurrentThread();
